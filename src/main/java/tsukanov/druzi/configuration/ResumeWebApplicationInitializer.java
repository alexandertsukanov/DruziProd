package tsukanov.druzi.configuration;
...
import tsukanov.druzi.component.impl.ApplicationListener;
import tsukanov.druzi.component.impl.DebugFilter;
import tsukanov.druzi.component.impl.ErrorHandler;
...
public class ResumeWebApplicationInitializer implements WebApplicationInitializer {
	...
	private WebApplicationContext createWebApplicationContext(ServletContext container) {
		...
		ctx.scan("tsukanov.druzi.configuration");
