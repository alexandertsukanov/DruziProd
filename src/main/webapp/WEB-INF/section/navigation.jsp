...
<nav class="navbar navbar-default druzi-nav">
	<div class="container-fluid">
		<div class="navbar-header">
			<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
				<span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span>
			</button>
			<a class="navbar-brand" href="/welcome" ><img style="left: 1px; top: -5px;width: 100px; height: 70px; position: absolute" src="/static/img/Druzi.png"></a>
		</div>
				...
				<sec:authorize access="hasAuthority('USER')">
					<li class="dropdown">
						...
						<ul class="dropdown-menu profile-menu">
							...
							<li><a href="javascript:druzi.logout('${_csrf.token}');"><i class="fa fa-sign-out"></i>Выйти</a></li>
						</ul></li>
				</sec:authorize>
			</ul>
