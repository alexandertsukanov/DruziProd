...
<druzi:edit-tab-header selected="skills"/>
...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<hr />
		<druzi:form-display-error-if-invalid formName="skillForm" />
		...
		<form:form action="/edit/skills" method="post" commandName="skillForm">
			...
			<div class="row">
				<div class="col-xs-12">
					<a href="javascript:druzi.ui.addBlock();">+ Добавить навык</a>
				</div>
			</div>
			<hr />
			<div class="row">
...
<script id="ui-block-template" type="text/x-handlebars-template">
	<druzi:edit-skill-block index="{{blockIndex}}" />
</script>