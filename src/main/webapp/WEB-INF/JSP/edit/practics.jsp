...
<druzi:edit-tab-header selected="practics"/>
...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<hr />
		<druzi:form-display-error-if-invalid formName="practicForm" />
		<form:form action="/edit/practics" method="post" commandName="practicForm">
			...
			<div id="ui-block-container">
				<c:forEach var="practic" items="${practicForm.items }" varStatus="status">
					<druzi:edit-practic-block index="${status.index}" practic="${practic }" />
				</c:forEach>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<a href="javascript:druzi.ui.addBlock();">+ Добавить </a>
				</div>
			</div>
			<hr />
			<div class="row">
...
<script id="ui-block-template" type="text/x-handlebars-template">
	<druzi:edit-practic-block index="{{blockIndex}}" />
</script>