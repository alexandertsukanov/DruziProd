...
<druzi:edit-tab-header selected="contacts" />
...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<form:form commandName="contactsForm" action="/edit/contacts" cssClass="form-horizontal data-form">
			...
			<div class="row">
				<div class="col-sm-7">
					<druzi:form-has-error path="skype" />
			...
			<div class="row">
				<div class="col-sm-7">
					<druzi:form-has-error path="vkontakte" />
					<div class="form-group ${hasError ? 'has-error' : ''}">
						...
						<div class="col-sm-8">
							...
							<druzi:form-error path="vkontakte" />
						</div>
					</div>
					<druzi:form-has-error path="facebook" />
					<div class="form-group ${hasError ? 'has-error' : ''}">
						...
						<div class="col-sm-8">
							...
							<druzi:form-error path="facebook" />
						</div>
					</div>
					<druzi:form-has-error path="linkedin" />
					<div class="form-group ${hasError ? 'has-error' : ''}">
						...
						<div class="col-sm-8">
							...
							<druzi:form-error path="linkedin" />
						</div>
					</div>
					<druzi:form-has-error path="github" />
					<div class="form-group ${hasError ? 'has-error' : ''}">
						...
						<div class="col-sm-8">
							...
							<druzi:form-error path="github" />
						</div>
					</div>
					<druzi:form-has-error path="stackoverflow" />
					<div class="form-group ${hasError ? 'has-error' : ''}">
						...
						<div class="col-sm-8">
							...
							<druzi:form-error path="stackoverflow" />
						</div>
					</div>
				</div>
				<div class="col-sm-5 help-block">
