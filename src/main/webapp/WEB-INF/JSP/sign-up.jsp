...
<div class="panel panel-info small-center-block">
	...
	<div class="panel-body">
		<druzi:form-display-error-if-invalid formName="profileForm" />
		<form:form action="/sign-up" commandName="profileForm" method="post">
			...
			<druzi:form-has-error path="firstName"/>
			<div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
				...
				<druzi:form-error path="firstName" />
			</div>
			
			<druzi:form-has-error path="lastName"/>
			<div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
				<label for="lastName">Фамилия</label> 
				<form:input path="lastName" id="lastName" cssClass="form-control" placeholder="Example: Hendricks" required="required"/>
				<druzi:form-error path="lastName" />
			</div>
			
			<druzi:form-has-error path="password"/>
			<div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
				...
				<druzi:form-error path="password" />
			</div>
			
			<druzi:form-has-error path="confirmPassword"/>
			<div class="form-group ${hasError ? 'has-error has-feedback' : ''}">
				...
				<druzi:form-error path="confirmPassword" />
			</div>
